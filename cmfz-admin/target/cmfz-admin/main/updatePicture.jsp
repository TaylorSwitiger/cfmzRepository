...
<div style="text-align: center;margin-top: 40px">
    <form id="p_up_form" method="post" enctype="multipart/form-data">
        海报 ID :<input id="p_up_son1" class="easyui-textbox" name="pictureId" data-options="label:'海报 ID :'" readonly/><br><br>
        海报描述:<input id="p_up_son2" class="easyui-textbox" name="pictureDescription" data-options="label:'海报描述:'"/><br><br>
        海报状态:<input id="p_up_son3" class="easyui-textbox" name="pictureStatus" data-options="label:'海报状态:'"/>
    </form><br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a id="p_up1">提交</a>&nbsp;&nbsp;
    <a id="p_up2">取消</a>
</div>
