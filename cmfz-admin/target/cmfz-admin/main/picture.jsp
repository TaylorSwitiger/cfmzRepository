...
<script type="text/javascript">
    ...
    $(function () {
        $("#t_picture").datagrid({
            ...
            columns:[[
                 ...
                 {title : "海报状态",field : "pictureStatus",width:30,
                     formatter: function(value,row,index){
                         if (row.pictureStatus == "发布"){
            ...
            detailFormatter: function(rowIndex, rowData){
                return '<img src="${pageContext.request.contextPath}' + rowData.picturePath + '" style="height:50px;"></td>';
            }
        });
    ...
    <table id="t_picture"></table>
        ...
        <div id="tool_picture">
            <shiro:hasPermission name="picture:add"><a id="p_b1" class="easyui-linkbutton" data-options="iconCls:'icon-add',text:'新增海报'"></a></shiro:hasPermission>
