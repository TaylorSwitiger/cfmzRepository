...
public class MyAdvice {
     ...
     * 声明切入点表达式
     */
    @Pointcut(value = "execution(* com.xuyiming.cmfz.service.impl.*.modify*(..)) || execution(* com.xuyiming.cmfz.service.impl.*.add*(..))")
    //@Pointcut("within(ManagerServiceImpl)") //基于类型的aop
    public void pc(){}
...
//    }
    ...
    public Object around(ProceedingJoinPoint pjp) throws Throwable { //连接点
        ...
        try {
            ...
            result = "fail";
            if ("账户已存在".equals(throwable.getMessage())) {
